...
-- ---------------------------------------------------------------------
CREATE TABLE AVION (
    matricula           INT             NOT NULL,  -- [PK][OBL] matricula numerica unica
    marca                VARCHAR(50)     NOT NULL,  -- [OBL]
    modelo               VARCHAR(50)     NOT NULL,  -- [OBL]
    capacidad            INT             NOT NULL,  -- [OBL] dominio: 200 a 800 asientos
...
CREATE TABLE EMPLEADO (
    rut                  VARCHAR(12)     NOT NULL,  -- [PK][OBL]
    nombre_completo       VARCHAR(100)    NOT NULL,  -- [OBL]
    direccion             VARCHAR(150)    NOT NULL,  -- [OBL]
    sueldo_base           DECIMAL(10,2)   NOT NULL,  -- [OBL]
    fecha_ingreso         DATE            NOT NULL,  -- [OBL]
    genero                CHAR(1)         NOT NULL,  -- [OBL] dominio: M, F, O
    telefono_movil        VARCHAR(20)     NOT NULL,  -- [OBL]
    telefono_contacto     VARCHAR(20)     NULL,      -- [OPC]
    tipo_empleado         VARCHAR(15)     NOT NULL,  -- [OBL] dominio: Piloto, Administrativo
...
-- ---------------------------------------------------------------------
CREATE TABLE PILOTO (
    rut                   VARCHAR(12)     NOT NULL,  -- [PK][FK -> EMPLEADO.rut][OBL]
    horas_vuelo_acumuladas DECIMAL(8,2)   NOT NULL,  -- [OBL]
    afp                    VARCHAR(50)    NOT NULL,  -- [OBL]
...
CREATE TABLE ADMINISTRATIVO (
    rut                   VARCHAR(12)     NOT NULL,  -- [PK][FK -> EMPLEADO.rut][OBL]
    horas_extras           DECIMAL(6,2)   NOT NULL,  -- [OBL]
    afp                    VARCHAR(50)    NOT NULL,  -- [OBL]
...
CREATE TABLE PASAJERO (
    pasaporte_cedula      VARCHAR(20)     NOT NULL,  -- [PK][OBL]
    nombre_completo        VARCHAR(100)   NOT NULL,  -- [OBL]
    fecha_nacimiento       DATE           NOT NULL,  -- [OBL]
    nacionalidad           VARCHAR(50)    NOT NULL,  -- [OBL]
    telefono_contacto      VARCHAR(20)    NULL,      -- [OPC]
    correo_electronico     VARCHAR(100)   NULL,      -- [OPC]
...
-- ---------------------------------------------------------------------
CREATE TABLE VUELO (
    numero_vuelo          VARCHAR(10)     NOT NULL,  -- [PK][OBL]
    fecha_despegue         DATE           NOT NULL,  -- [OBL]
    fecha_llegada          DATE           NOT NULL,  -- [OBL]
    hora_salida            TIME           NOT NULL,  -- [OBL]
    ciudad_origen          VARCHAR(50)    NOT NULL,  -- [OBL]
    ciudad_destino         VARCHAR(50)    NOT NULL,  -- [OBL]
    matricula_avion        INT            NOT NULL,  -- [FK -> AVION.matricula][OBL]
...
CREATE TABLE RESERVA (
    numero_reserva         INT            NOT NULL,  -- [PK][OBL]
    fecha_reserva          DATE           NOT NULL,  -- [OBL]
    fecha_viaje            DATE           NOT NULL,  -- [OBL]
    asiento                 VARCHAR(5)    NULL,      -- [OPC] solo si se selecciono al reservar
    estado                  VARCHAR(12)   NOT NULL,  -- [OBL] dominio: Confirmada, Nula
    pasaporte_cedula        VARCHAR(20)   NOT NULL,  -- [FK -> PASAJERO.pasaporte_cedula][OBL]
    numero_vuelo            VARCHAR(10)   NOT NULL,  -- [FK -> VUELO.numero_vuelo][OBL]
    rut_empleado            VARCHAR(12)   NOT NULL,  -- [FK -> ADMINISTRATIVO.rut][OBL]
...
CREATE TABLE EQUIPAJE (
    codigo                  VARCHAR(15)   NOT NULL,  -- [PK][OBL]
    color                    VARCHAR(30)  NOT NULL,  -- [OBL]
    peso                     DECIMAL(5,2) NOT NULL,  -- [OBL] kilogramos, ej: 25.90
    descripcion               VARCHAR(200) NULL,     -- [OPC]
    tipo_embarque             VARCHAR(12)  NOT NULL, -- [OBL] dominio: Prioritario, Normal
...
CREATE TABLE RESERVA_EQUIPAJE (
    numero_reserva          INT           NOT NULL,  -- [PK][FK -> RESERVA.numero_reserva][OBL]
    codigo_equipaje          VARCHAR(15)  NOT NULL,   -- [PK][FK -> EQUIPAJE.codigo][OBL]
